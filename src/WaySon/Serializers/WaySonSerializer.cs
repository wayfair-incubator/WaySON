...
using WaySON.Converters;

namespace WaySON.Serializers
{
    /// <summary>
    ...
    ///     Singleton.
    /// </summary>
    public sealed class WaySONSerializer
    {
        private static readonly Lazy<WaySONSerializer> LazyInstance = new Lazy<WaySONSerializer>(
            () => new WaySONSerializer());

        private JsonSerializerOptions _options;

        private WaySONSerializer()
        {
        ...
        private static WaySONSerializer Serializer()
        {
