...
namespace Wayfair.Text.Json.UnitTests.Serialization
{
    ...
    public class DictionaryStringLongSerializationTests
    {
        ...
        public void Can_Deserialize_DictionaryStringLong_Into_Object()
        {
            ...
            // act
            var testDictStringLongObj = WayfairJsonSerializer.Deserialize<TestDictStringLongObj>(json);
        ...
        public void Deserializing_Dictionary_With_Bad_Key_Throws_JsonException()
        {
            ...
            try
            {
                var _ = WayfairJsonSerializer.Deserialize<TestDictStringLongObj>(json);
            }
            catch (JsonException)
            {
