...
namespace Wayson.UnitTests.Serialization
{
    ...
    public class IDictionaryEnumSerializationTests
    {
        ...
        public void Can_Deserialize_IDictionaryEnumLong()
        {
            ...
            // act
            var dictionary = WaySONSerializer.Deserialize<IDictionary<TestEnum, long>>(json);
        ...
        public void Can_Deserialize_IDictionaryEnumNullableDecimal()
        {
            ...
            // act
            var dictionary = WaySONSerializer.Deserialize<IDictionary<TestEnum, decimal?>>(json);
        ...
        public void Deserializing_Dictionary_With_Bad_Key_Throws_JsonException()
        {
            ...
            try
            {
                var _ = WaySONSerializer.Deserialize<IDictionary<TestEnum, decimal?>>(json);
            }
            catch (JsonException)
            {
