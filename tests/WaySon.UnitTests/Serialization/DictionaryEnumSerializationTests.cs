...
namespace Wayson.UnitTests.Serialization
{
    ...
    public class DictionaryEnumSerializationTests
    {
        ...
        public void Can_Deserialize_Enum_Into_Its_Name()
        {
            ...
            // act
            var testEnum = WaySONSerializer.Deserialize<TestEnum>(json);
        ...
        public void Can_Deserialize_DictionaryEnumLong()
        {
            ...
            // act
            var dictionary = WaySONSerializer.Deserialize<Dictionary<TestEnum, long>>(json);
        ...
        public void Can_Deserialize_DictionaryEnumNullableDecimal()
        {
            ...
            // act
            var obj = WaySONSerializer.Deserialize<Dictionary<TestEnum, decimal?>>(json);
        ...
        public void Deserializing_Dictionary_With_Bad_Key_Throws_JsonException()
        {
            ...
            try
            {
                var _ = WaySONSerializer.Deserialize<Dictionary<TestEnum, decimal?>>(json);
            }
            catch (JsonException)
            {
